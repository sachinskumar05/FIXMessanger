		...
		AbstractMemberPanel<Field, StringField, com.sachin.fix.xml.FieldType>
{
	...
	public com.sachin.fix.xml.FieldType getXmlMember()
	{
		if (!StringUtil.isNullOrEmpty(getValue()))
		{
			com.sachin.fix.xml.FieldType xmlFieldType = new ObjectFactory()
					.createFieldType();
	...
	public void populateXml(com.sachin.fix.xml.FieldType xmlFieldType)
	{
